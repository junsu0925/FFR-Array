function [RadiationTable,RadiationAreaFactorTable,TableParameter] = RadiationImpTable_ParameterNo8(Geometry, rhowater, sp, kaForTable)
...
% Load Data File
dataCell = textscan(fid,'%f%f%f%f%f%f%f%f%f');
data = [dataCell{1} dataCell{2} dataCell{3} dataCell{4} dataCell{5}...
    dataCell{6} dataCell{7} dataCell{8} dataCell{9}];
