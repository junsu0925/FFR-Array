...
gaRatioVector = Geometry.gCenterValue./Geometry.a;
gLRatioVector = Geometry.gCenterValue./Geometry.RL(1);

x_axisL = gLRatioVector;
x_axisa = gaRatioVector;
...
% figure(4)
% subplot(3,1,1)
% plot(x_axisL,StartKaRatio,'LineWidth',2)
% xlim([0.10/Geometry.RL(1) 0.2/Geometry.RL(1)])
% grid on
...
% 
% subplot(3,1,2)
% plot(x_axisL,EndKaRatio,'LineWidth',2)
% xlim([0.10/Geometry.RL(1) 0.2/Geometry.RL(1)])
% grid on
...
% 
% subplot(3,1,3)
% plot(x_axisL,Bandwidth,'LineWidth',2)
% xlim([0.10/Geometry.RL(1) 0.2/Geometry.RL(1)])
% grid on
...
% 
% figure(5)
% plot(x_axisL,MaxTVRLevel,'LineWidth',2)
% xlim([0.10/Geometry.RL(1) 0.2/Geometry.RL(1)])
% grid on
...
figure(4)
subplot(3,1,1)
plot(x_axisa,StartKaRatio,'LineWidth',2)
% xlim([0.10/Geometry.a 0.2/Geometry.a])
grid on
title('Start position of Bandwidth','fontsize',24, 'fontangle','italic');
...
subplot(3,1,2)
plot(x_axisa,EndKaRatio,'LineWidth',2)
% xlim([0.10/Geometry.a 0.2/Geometry.a])
grid on
title('End position of Bandwidth','fontsize',24, 'fontangle','italic');
xlabel('g/a ratio','fontsize',24, 'fontangle','italic');
...
subplot(3,1,3)
plot(x_axisa,Bandwidth,'LineWidth',2)
% xlim([0.10/Geometry.a 0.2/Geometry.a])
grid on
title('Bandwidth','fontsize',24, 'fontangle','italic');
xlabel('g/a ratio','fontsize',24, 'fontangle','italic');
...
figure(5)
plot(x_axisa,MaxTVRLevel,'LineWidth',2)
% xlim([0.10/Geometry.a 0.2/Geometry.a])
grid on
title('TVR','fontsize',24, 'fontangle','italic');
xlabel('g/a ratio','fontsize',24, 'fontangle','italic');
